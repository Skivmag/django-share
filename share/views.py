...
class EmailFormView(FormView):
   ...
   def form_valid(self, form):
      send_mail('Someone wants to share something with you!', escape(form.cleaned_data['message']),
                escape(form.cleaned_data['email_from']), [escape(form.cleaned_data['email_to'])], fail_silently=False)
